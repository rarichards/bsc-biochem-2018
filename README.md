...
Here is the code (Tcl and R) used for my final year project for my BSc in Biochemistry at the University of Bath. The project was set out to analyse the GC content at the third codon position (GC3) in 5’ and 3’ gene termini, and its effect on optimal growth temperature and gene expression levels.
