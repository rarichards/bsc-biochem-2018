#The following script was used to extract individual genes and write them into one FASTA file per genome
...
set flist [glob -nocomplain -directory codonw_genomes *.embl]
...
foreach genome $flist {
	...
	if {[file exists "$accn.fasta"] ==1} {file delete "$accn.fasta"} 

	set out_genes [open "$accn.fasta" a]
